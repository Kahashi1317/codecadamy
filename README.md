# codecademy
In the first line of the program, define a variable called userName that is set to an empty string.  If you want to, you can enter your name in between the quotation marks.
